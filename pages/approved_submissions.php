...
<body>
    ...
    <main class="container-fluid p-3">
        ...
        <ul class="nav nav-underline mb-5">
            ...
            <li class="nav-item">
                <a class="nav-link active px-3" href="/approved_submissions">Approved/ Completed <small>(10)</small></a>
            </li>
            <li class="nav-item">
                <a class="nav-link px-3" href="/cancelled_submissions">Withdrawn/Cancelled <small>(10)</small></a>
            </li>
        </ul>
