                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="d-flex flex-row justify-content-start align-items-center gap-2 mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    <span><strong><?php echo isset($announcement['announcement_author']) ? htmlspecialchars($announcement['announcement_author']) : 'Unknown Author'; ?></strong></span>
<!--NAME OF AUTHOR-->
                 ...
                 if (!empty($comments)): ?>
                    ...
                    <ul>
                        <?php foreach ($comments as $comment): ?>
                            <li>
                                <strong><?= htmlspecialchars($comment['username'] ?? 'Unknown Volunteer') ?>:</strong>
