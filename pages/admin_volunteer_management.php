...
<main class="container p-5">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="volunteer-tab" data-bs-toggle="tab" data-bs-target="#volunteer-tab-pane" type="button" role="tab" aria-controls="volunteer-tab-pane" aria-selected="true">List of Volunteer</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending-tab-pane" type="button" role="tab" aria-controls="pending-tab-pane" aria-selected="false">Pending Approval</button>
            </li>
        </ul>

        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active p-3" id="volunteer-tab-pane" role="tabpanel" aria-labelledby="volunteer-tab" tabindex="0">
                <table class="table">
            ...
            <div class="tab-pane fade p-3" id="pending-tab-pane" role="tabpanel" aria-labelledby="pending-tab" tabindex="0">
                <table class="table">
                    <thead class="table-primary">
                        <tr>
                            <th>ID</th>
