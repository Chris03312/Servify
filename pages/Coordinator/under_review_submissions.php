    ...
    <main class="container-fluid p-3">
        ...
        <div class="table-responsive">
            <table id="review" class="table table-hover align-middle">
                ...
                <tbody>
                    <?php if (!empty($underreviewApplications)): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-none d-md-flex flex-row gap-2">
                                        <form
                                            action="/under_review_submissions/review?token=<?php echo urlencode($_GET['token']); ?>"
                                            method="POST">
                                    ...
                                    <div class="d-flex d-md-none flex-column">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <form
                                                    action="/approved_submissions/review?token=<?php echo urlencode($_GET['token']); ?></form>"
                                                    method="POST">
                                                    <input type="hidden" name="application_id"
                                                        value="<?php echo htmlspecialchars($application['APPLICATION_ID']); ?>">
