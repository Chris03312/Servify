            ...
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="coor-profile-tab" data-bs-toggle="tab" data-bs-target="#coor-profile-tab-pane" type="button" role="tab" aria-controls="coor-profile-tab-pane" aria-selected="true">Coordinator's Profile</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="assigned-precinct-tab" data-bs-toggle="tab" data-bs-target="#assigned-precinct-tab-pane" type="button" role="tab" aria-controls="assigned-precinct-tab-pane" aria-selected="false">Assigned Precinct</button>
                    </li>
                </ul>
                ...
                <div class="tab-content border-start border-end border-bottom" id="myTabContent" style="border-top: 10px solid blue;">
                    ...
                    <div class="tab-pane fade show active p-3" id="coor-profile-tab-pane" role="tabpanel" aria-labelledby="coor-profile-tab" tabindex="0">
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex justify-content-end">
                                <img src="../img/DPPAM LOGO.png" alt="Coordinator's Profile" class="img-thumbnail" style="width: 150px; height: 150px;">
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="parishName" name="parishName" required readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="middlename" name="middleName" required readonly>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label for="suffix" class="form-label">Suffix</label>
                                <input type="text" class="form-control" id="suffix" name="suffix" placeholder="e.g., Jr., Sr., III, IV" required readonly>
                            </div>
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" class="form-control" id="birthDate" name="birthDate" placeholder="Date" required readonly>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label for="birthMonth" class="form-label">Month</label>
                                <select id="birthMonth" name="birthMonth" class="form-select" aria-readonly="true" required disabled>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="citizenship" name="citizenship" required readonly>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="occupation" name="occupation" required readonly>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" readonly id="barangay1" name="barangay1" required>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="mobileNumber" name="mobileNumber" required readonly>
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="telNumber" class="form-label">Tel no.</label>
                                <input type="text" class="form-control" id="telNumber" name="telNumber" required readonly>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="prevOrgMem" name="prevOrgMem" required readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="prevAssignment" class="form-label">Previous PPCRV Assignment</label>
                                <input type="text" class="form-control" id="prevAssignment" name="prevAssignment" required readonly>
                            </div>

                            <span>Previous PPCRV Experience</span>
                            <div class="col-md-3 mb-3">
                                <label for="prevExpDate" class="form-label">Date</label>
                                <input type="text" class="form-control" readonly id="prevExpDate" name="prevExpDate" placeholder="Date" required readonly>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" class="form-control" id="prevExpYear" name="prevExpYear" placeholder="Year" readonly>
                            </div>

                            <div class="col-md-3 mb-3">
                                <label for="yearsOfServices" class="form-label">Years of service</label>
                                <input type="text" class="form-control" id="yearsOfServices" name="yearsOfServices" placeholder="Year" readonly>
                            </div>
                    ...
                    <!--DOCUMENTS-->
                    <div class="tab-pane fade p-3" id="assigned-precinct-tab-pane" role="tabpanel" aria-labelledby="assigned-precinct-tab" tabindex="0">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>QC</td>
                                        <td>3</td>
                                        <td><button type="button" class="btn btn-sm text-danger"><i class="bi-trash me-2"></i><span>Delete</span></button></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>LES</td>
